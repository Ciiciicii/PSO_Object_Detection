# Stochastic Inertia Weight Particle Swarm Optimization
# weights random from 0.5 to 1.0
import random 
import math
...
class Particle:
    ...
    def update_velocity(self, global_best, iter):
        ...
        w = random.uniform(0.5, 1)   # inertial weight
        c1 = 1.494      # cognitive factor (local best)     
        c2 = 1.494      # social factor (global best)
