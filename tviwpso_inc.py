# Time Varying Inertia Weight Particle Swarm Optimization 
# increase weight linearly over iteration
import random 
import math
...
class Particle:
    ...
    def update_velocity(self, global_best, maxiter, iter):
        # update inertial weight if target is located
        w = 0.4 + (0.9 - 0.4)/maxiter * iter   # inertial weight
        c1 = 2     # cognitive factor (local best)     
        c2 = 2      # social factor (global best)
